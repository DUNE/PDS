...
@click.option("--input_dir", 
              default='/eos/experiment/neutplatform/protodune/experiments/ProtoDUNE-II/PDS_Commissioning/ivcurves',
              help="Folder with all iv curve data (default = '/eos/experiment/neutplatform/protodune/experiments/ProtoDUNE-II/PDS_Commissioning/ivcurves'") 
@click.option("--run", 
              default='May-17-2024-run00',
              help="Run to analyze (default = 'May-17-2024-run00' ") 
    ...
    for endpoint_folder in ENDPOINT_FOLDERS: #Cycle on endpoint_folders in the input directory
        if len(endpoint_folder) > 40:
            ...
            if timestamp <  datetime(2024, 4, 19):
                ...
                chdir(f"{input_dir}/{run}/{str(endpoint_folder)}")
                ...
                for ch in dic['fbk']+dic['hpk']:
                    ...
                    if file_name in FILES: #Check if the file is present 
                        try: 
                            ...
                            if e.errno == 14:  
                                print("Bad address error. The file might be corrupted or inaccessible.")
